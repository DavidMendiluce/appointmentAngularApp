...
@Component({
  ...
  styleUrls: ['./signup.component.css', '../reservation-form/reservation-form.component.css', '../reservation-details/reservation-details.component.css', '../main-page/main-page.component.css']
})
export class SignupComponent implements OnInit {
  ...
  miniHeader() {
    ...
    if(this.setMiniHeader == false) {
      $('#headerSearchContainer').removeClass('makeSearchboxLarger');
      $('#headerSearchContainer').addClass('makeSearchboxSmaller');
  ...
  onSignup() {
    ...
    this.authService.createUser(email, password, name, surname);
  ...
  resetHeaderSerarchBox() {
    if(this.setMiniHeader == true) {
    $('#headerSearchContainer').addClass('makeSearchboxLarger');
    $('#headerSearchContainer').removeClass('makeSearchboxSmaller');
