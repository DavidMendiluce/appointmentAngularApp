...
@Component({
  ...
  styleUrls: ['./login.component.css', '../reservation-form/reservation-form.component.css', '../reservation-details/reservation-details.component.css', '../main-page/main-page.component.css']
})
export class LoginComponent implements OnInit {
  ...
  miniHeader() {
    ...
    if(this.setMiniHeader == false) {
      $('#headerSearchContainer').removeClass('headerFullHeight');
      $('#headerSearchContainer').addClass('headerMiniHeight');
  ...
  resetHeaderSerarchBox() {
    if(this.setMiniHeader == true) {
    $('#headerSearchContainer').addClass('headerFullHeight');
    $('#headerSearchContainer').removeClass('headerMiniHeight');
